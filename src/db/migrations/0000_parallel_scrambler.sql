...
CREATE TYPE "public"."message_type" AS ENUM('text', 'image', 'file', 'audio', 'system');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE UNIQUE INDEX "conversation_user_idx" ON "conversation_members" USING btree ("conversation_id","user_id");